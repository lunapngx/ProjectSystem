...
<?= $this->section('content') ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 image-col" data-aos="fade-left" data-aos-delay="200">
                    <div class="hero-image">
                        <img src="<?= base_url('assets/img/product/product-f-9.webp') ?>" alt="Fashion Product" class="main-product" loading="lazy">
                        <div class="floating-product product-1" data-aos="fade-up" data-aos-delay="300">
                            <img src="<?= base_url('assets/img/product/product-4.webp') ?>" alt="Product 2">
                        ...
                        <div class="floating-product product-2" data-aos="fade-up" data-aos-delay="400">
                            <img src="<?= base_url('assets/img/product/product-3.webp') ?>" alt="Product 3">
                            <div class="product-info">
                                <h4>Casual Wear</h4>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="category-card" data-aos="fade-up" data-aos-delay="100">
                        <div class="category-image">
                            <img src="<?= base_url('assets/img/product/product-1.webp') ?>" alt="Category" class="img-fluid">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card" data-aos="fade-up" data-aos-delay="200">
                        <div class="category-image">
                            <img src="<?= base_url('assets/img/product/product-6.webp') ?>" alt="Category" class="img-fluid">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card" data-aos="fade-up" data-aos-delay="300">
                        <div class="category-image">
                            <img src="<?= base_url('assets/img/product/product-9.webp') ?>" alt="Category" class="img-fluid">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card" data-aos="fade-up" data-aos-delay="400">
                        <div class="category-image">
                            <img src="<?= base_url('assets/img/product/product-f-1.webp') ?>" alt="Category" class="img-fluid">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card" data-aos="fade-up" data-aos-delay="500">
                        <div class="category-image">
                            <img src="<?= base_url('assets/img/product/product-10.webp') ?>" alt="Category" class="img-fluid">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card" data-aos="fade-up" data-aos-delay="600">
                        <div class="category-image">
                            <img src="<?= base_url('assets/img/product/product-m-1.webp') ?>" alt="Category" class="img-fluid">
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="category-card" data-aos="fade-up" data-aos-delay="800">
                        <div class="category-image">
                            <img src="<?= base_url('assets/img/product/product-2.webp') ?>" alt="Category" class="img-fluid">
                        </div>
            ...
            <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?= base_url('assets/img/product/product-1.webp') ?>" class="img-fluid default-image" alt="Product" loading="lazy">
                        <img src="<?= base_url('assets/img/product/product-1-variant.webp') ?>" class="img-fluid hover-image" alt="Product hover" loading="lazy">
                    ...
                    <div class="product-info">
                        <h3 class="product-title"><a href="<?= base_url('products/1') ?>">Lorem ipsum dolor sit amet</a></h3>
    ...
    <div class="container isotope-layout" data-aos="fade-up" data-aos-delay="100" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            ...
            <div class="col-md-6 col-lg-3 product-item isotope-item filter-clothing">
                <div class="product-card">
                    <div class="product-image">
                        ...
                        <img src="<?= base_url('assets/img/product/product-11.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-11-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/5') ?>">Lorem ipsum dolor sit amet</a></h5>
                        <div class="product-price">
                            <span class="current-price">$89.99</span>
                ...
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?= base_url('assets/img/product/product-9.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-9-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                                <a href="#" class="action-btn"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/6') ?>">Consectetur adipiscing elit</a></h5>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image">
                        ...
                        <img src="<?= base_url('assets/img/product/product-3.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-3-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                                <a href="#" class="action-btn"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/7') ?>">Sed do eiusmod tempor</a></h5>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?= base_url('assets/img/product/product-4.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-4-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                                <a href="#" class="action-btn"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/8') ?>">Incididunt ut labore et dolore</a></h5>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <span class="badge">Sale</span>
                        <img src="<?= base_url('assets/img/product/product-5.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-5-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                                <a href="#" class="action-btn"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/9') ?>">Magna aliqua ut enim ad minim</a></h5>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?= base_url('assets/img/product/product-6.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-6-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                                <a href="#" class="action-btn"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/10') ?>">Veniam quis nostrud exercitation</a></h5>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <span class="badge">New</span>
                        <img src="<?= base_url('assets/img/product/product-7.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-7-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                                <a href="#" class="action-btn"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/11') ?>">Ullamco laboris nisi ut aliquip</a></h5>
                        <div class="product-price">
                ...
                <div class="product-card">
                    <div class="product-image">
                        <img src="<?= base_url('assets/img/product/product-8.webp') ?>" alt="Product" class="img-fluid main-img">
                        <img src="<?= base_url('assets/img/product/product-8-variant.webp') ?>" alt="Product Hover" class="img-fluid hover-img">
                        <div class="product-overlay">
                            <a href="<?= base_url('cart') ?>" class="btn-cart"><i class="bi bi-cart-plus"></i> Add to Cart</a>
                            <div class="product-actions">
                                <a href="#" class="action-btn"><i class="bi bi-heart"></i></a>
                    ...
                    <div class="product-info">
                        <h5 class="product-title"><a href="<?= base_url('products/12') ?>">Ex ea commodo consequat</a></h5>
                        <div class="product-price">
        ...
        <div class="text-center mt-5" data-aos="fade-up">
            <a href="<?= base_url('products') ?>" class="view-all-btn">View All Products <i class="bi bi-arrow-right"></i></a>
        </div>
